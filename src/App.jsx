    ...
    <>
     <div className='bg-dark d-flex justify-content-center align-items-center' style={{height:"100vh", width:"100%"}} >
        ...
        <div className='bg-light p-5 rounded-2' style={{width:"500px"}} >
          ...
          <div className='my-3 ' >
          <TextField id="outlined-basic" label="Principle amount" variant="outlined" className='w-100' value={principle} name = "principle" onChange={(e)=>validate(e)}/>
            { isPrinciple==false && <p className='text-danger' >*Invalid input</p>}
          </div>

          <div className='my-3' >
          <TextField id="outlined-basic" label="Rate of interest" variant="outlined" className='w-100' value={rate} name='rate' onChange={(e)=>validate(e)} />
          { isRate==false && <p className='text-danger' >*Invalid input</p>}
          </div>

          <div className='my-3 ' >
          <TextField id="outlined-basic" label="year" variant="outlined" className='w-100' name='year' value={year} onChange={(e)=>validate(e)} />
